...
public class FilmDbStorage implements FilmStorage {
    ...
    private void addFilmGenre(long film_id, int genre_id) {
        String addFilmGenreSQL = "INSERT INTO FILM_GENRE (FILM_ID, GENRE_ID) VALUES (?,?)";

        try {
            jdbcTemplate.update(addFilmGenreSQL, film_id, genre_id);
    ...
    public Film createFilm(Film film) {
        ...
        film.getGenres().forEach(genre -> addFilmGenre(film_id, genre.getId()));

        return findFilmById(film_id).orElseThrow();
    }
